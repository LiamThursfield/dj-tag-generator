...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'audio.sample_rate' => 'integer',
            'audio.bitrate' => 'string',
            'audio.max_duration' => 'integer',
            'audio.storage_disk' => 'string',
            'audio.cleanup_days' => 'integer',
            'audio.max_text_length' => 'integer',
            'audio.max_file_size' => 'integer',
            'audio.allowed_formats' => 'array',
            'audio.rate_limiting.enabled' => 'boolean',
            'audio.rate_limiting.max_per_hour' => 'integer',
            'audio.rate_limiting.max_per_day' => 'integer',
            'audio.ffmpeg.binary' => 'string',
            'audio.ffmpeg.ffprobe' => 'string',
            'audio.ffmpeg.timeout' => 'integer',
            'audio.ffmpeg.threads' => 'integer',
            'audio.effects.reverb.small_room.name' => 'string',
            'audio.effects.reverb.small_room.filter' => 'string',
            'audio.effects.reverb.large_hall.name' => 'string',
            'audio.effects.reverb.large_hall.filter' => 'string',
            'audio.effects.reverb.stadium.name' => 'string',
            'audio.effects.reverb.stadium.filter' => 'string',
            'audio.effects.pitch.min' => 'integer',
            'audio.effects.pitch.max' => 'integer',
            'audio.effects.speed.min' => 'double',
            'audio.effects.speed.max' => 'double',
            'audio.effects.bass_boost.filter' => 'string',
            'audio.effects.normalize.filter' => 'string',
            ...
            'filesystems.disks.minio.report' => 'boolean',
            ...
            'filesystems.disks.r2.report' => 'boolean',
            ...
            'services.tts.default' => 'string',
            'services.tts.fake.enabled' => 'boolean',
            'services.tts.fake.file_path' => 'string',
            'services.openai.organization' => 'NULL',
            'services.openai.model' => 'string',
            'services.openai.voice' => 'string',
            'services.elevenlabs.model' => 'string',
            'services.minio.endpoint' => 'string',
            'services.minio.access_key_id' => 'string',
            'services.minio.secret_access_key' => 'string',
            'services.minio.bucket' => 'string',
            'services.minio.use_path_style_endpoint' => 'boolean',
            'services.r2.access_key_id' => 'NULL',
            'services.r2.secret_access_key' => 'NULL',
            'services.r2.bucket' => 'NULL',
            'services.r2.endpoint' => 'NULL',
...
'app.aliases.View','app.aliases.Vite','audio.output_format','audio.sample_rate','audio.bitrate',
'audio.max_duration','audio.storage_disk','audio.cleanup_days','audio.max_text_length','audio.max_file_size',
'audio.allowed_formats','audio.rate_limiting.enabled','audio.rate_limiting.max_per_hour','audio.rate_limiting.max_per_day','audio.ffmpeg.binary',
'audio.ffmpeg.ffprobe','audio.ffmpeg.timeout','audio.ffmpeg.threads','audio.effects.reverb.small_room.name','audio.effects.reverb.small_room.filter',
'audio.effects.reverb.large_hall.name','audio.effects.reverb.large_hall.filter','audio.effects.reverb.stadium.name','audio.effects.reverb.stadium.filter','audio.effects.pitch.min',
'audio.effects.pitch.max','audio.effects.speed.min','audio.effects.speed.max','audio.effects.bass_boost.filter','audio.effects.normalize.filter',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.minio.driver',
...
'filesystems.disks.minio.use_path_style_endpoint','filesystems.disks.minio.throw','filesystems.disks.minio.report','filesystems.disks.r2.driver','filesystems.disks.r2.key',
'filesystems.disks.r2.secret','filesystems.disks.r2.region','filesystems.disks.r2.bucket','filesystems.disks.r2.endpoint','filesystems.disks.r2.use_path_style_endpoint',
'filesystems.disks.r2.throw','filesystems.disks.r2.report','filesystems.links./var/www/html/public/storage','fortify.guard','fortify.middleware',
...
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.tts.default',
'services.tts.fake.enabled','services.tts.fake.file_path','services.openai.organization','services.openai.model','services.openai.voice',
'services.elevenlabs.model','services.minio.endpoint','services.minio.access_key_id','services.minio.secret_access_key','services.minio.bucket',
'services.minio.use_path_style_endpoint','services.r2.access_key_id','services.r2.secret_access_key','services.r2.bucket','services.r2.endpoint',
...
'session.partitioned','boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains','ide-helper.filename',
...
'two-factor.disable','two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','home','dashboard','dj-tags.index','dj-tags.create',
'dj-tags.store','dj-tags.show','voices.index','settings.profile.edit',
'settings.profile.update','settings.profile.destroy','settings.user-password.edit','settings.user-password.update','settings.appearance.edit',
'settings.two-factor.show','settings.api-services.edit','settings.api-services.update','storage.local',);
...
'MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MINIO_ENDPOINT','MINIO_ACCESS_KEY_ID',
'MINIO_SECRET_ACCESS_KEY','MINIO_BUCKET','MINIO_USE_PATH_STYLE_ENDPOINT','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY',
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','AUDIO_RATE_LIMITING_ENABLED',
'SAIL_XDEBUG_MODE','SAIL_XDEBUG_CONFIG',);
